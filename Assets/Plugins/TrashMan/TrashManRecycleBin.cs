...
/// <summary>
/// the TrashManRecycleBin really wants to be a private class internal to TrashMan but since we want to use an Editor and don't want to get all anal
/// about things we just leave it public
/// </summary>
public partial class TrashMan : MonoBehaviour
{
	...
	} // end TrashManRecycleBin

} // end partial TrashMan class
